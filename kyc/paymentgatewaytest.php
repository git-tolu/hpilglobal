...
?>
<H6><center>Payment of a NON-REFUNDABLE FEE OF N250, 000 (Two Hundred and Fifty Thousand Naira Only)</center></H6>

							<form method="POST" action="https://prod.p2vest.com/v1">
 <input type="hidden" name="public_key" value="FLWPUBK_TEST-bf205e5e23bf56e7f23e364b053bb7d5-X" />
  
  <div class="form-group">
  <label for="com1" class="control-label col-form-label">Your Email Address </label>
  <input value ="ddgf@sfsd.f" type="email" class="form-control"   name="email" required />
 </div>
  
  <div class="form-group">
  <label for="com1" class="control-label col-form-label">Your Phone Number </label>
  <input value ="kjkkljljlkj" type="hidden" class="form-control" name="username"  required />
  </div>
  ...
  <input  value ="79999" type="text" class="form-control"  name="amount" required />
  </div>
