...
unset($_SESSION['cadre']);
unset($_SESSION['affirm']);
...
<div class="card border-danger">
    <div class="card-header bg-danger">
        <h4 class="m-b-0 text-white">REGISTRATION ON HOLD!</h4></div>
    <div class="card-body">
    <CENTER>    
<H1>SORRY!<SMALL><BR>REGISTRATION IS NOT POSSIBLE AT THIS TIME. PLEASE TRY AGAIN LATER<SMALL></H1>
										...
										<div class="col-md-12">       
	  <br> 
	 <a href='index.php'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-success">RETURN HOME </button></a>
		</div>
