...
if (isset($_POST['submitform'])) {
    ...
    $sqlm = "SELECT *FROM membership WHERE emailaddress ='$emailaddress' AND yearreg='$yearreg' AND status='active'";
    ...
    if (mysqli_num_rows($resultm) > 0) {
        ...
        $id = 0;
        $sql = "INSERT INTO confirmemail VALUES ('$id', '$agencyname', '$contactperson', '$designation', '$emailaddress', '$confirmcode', 'active', '$datereg')";
        if (mysqli_query($conn, $sql)) {
            include("../adminmanager/emailtemplates/confirmemail.php");
        } else {
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input required name="agencyname" type="text"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input required name="emailaddress" type="email"
                                                    class="form-control form-control-lg" placeholder=""
                                                    aria-label="Password" aria-describedby="basic-addon1">
                                            </div>
                                            ...
                                            <div class="form-group text-center">
                                                <div class="col-xs-12 p-b-20">
                                                    <button class="btn btn-block btn-lg btn-info" type="submit"
                                                        name="submitform">CONFIRM EMAIL ADDRESS </button>
                                                </div>
                                            </div>
                                        </form>
                ...
                <footer class="footer text-center">
                    All Rights Reserved by EXMAN . Designed and Developed by <a href="https://uptechng.com"
