...
if (isset($_POST['EmailValidationBTN'])) {
    ...
    if (!empty($email)) {
        // $sql = "SELECT * FROM `usertransactiondetails`  WHERE  `email`='$email' AND (firstname='$firstName' AND lastname='$lastName')";
        ...
        // } else {
        $sql = "INSERT INTO `kyc` (`user_id`,`email`) VALUES ('$user_id', '$email')";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            ...
            $status = 'pending';
            $sql = "INSERT INTO `emailconfirmation` (`user_id`, `code`, `status`) VALUES ('$user_id', '$emailmessage', '$status')";
            $result = mysqli_query($conn, $sql);
            $fullname = 'User';
                                            ...
                                            <div class="form-group text-center">
                                                <div class="col-xs-12 p-b-20">
                                                    <button class="btn btn-block btn-lg "
                                                        ...
                                                        name="EmailValidationBTN">Send Verification Code</button>
                                                </div>
                                            </div>
                                        </form>
