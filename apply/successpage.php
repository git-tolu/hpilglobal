...
<div class="card border-danger">
    <div class="card-header bg-danger">
        <h4 class="m-b-0 text-white">REGISTRATION SUCCESSFULL!</h4></div>
    <div class="card-body">
    <CENTER>    
<H1>SUCCESSFULL!<SMALL><BR>YOUR REGISTRATION IS SUCCESSFULL!<SMALL></H1>
										...
										<div class="col-md-12">       
	  <br> 
	   <a href='registration.php'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-success">REGISTER ANOTHER PERSON </button></a>
