...
<div class="card border-danger">
    <div class="card-header bg-info">
        <h4 class="m-b-0 text-white">REGISTRATION FAILED!</h4></div>
    <div class="card-body">
    <CENTER>    
<H1>FAILED!<SMALL><BR>SORRY! YOUR REGISTRATION IS NOT SUCCESSFUL.<SMALL></H1>
										...
										<div class="col-md-12">       
	  <br> 
	 <a href='index.php'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-info">RESTART THE PROCESS </button></a>
		</div>
