...
$agencyname = $_SESSION['cname'] ;
$emailaddress = $_SESSION['email'] ;
$contactperson = $_SESSION['userfullname'] ;
//$designation = $_SESSION['designation'];
$mphone = $_SESSION['mphone'] ;
$userid = $_SESSION['username'] ;
$tx_ref = $_SESSION['username'];
$amounttopayf = number_format($_SESSION['totalamount'],2);
...
?>
<H6><center>Payment your outstanding membership due of N<?php echo $amounttopayf;?> </center></H6>
 ...
 <input type="hidden" name="public_key" value="FLWPUBK-ffc22359cb9fcb86c9432adbca55949b-X" />
  ...
  <input readonly value ="<?php echo $mphone; ?>" type="text" class="form-control"   required />
  <input value ="<?php echo $mphone; ?>" type="hidden" class="form-control" name="customer[phone_number]"  required />
  </div>
  ...
  <input readonly value ="<?php echo $amounttopayf; ?>" type="text" class="form-control"  required />
  </div>
 ...
 <input type="hidden" name="redirect_url" value="https://membership.exman.com.ng/myaccount/savepaymentowing.php" />
