...
<div class="card border-info">
    ...
    <div class="card-body">
							...
							You can now login to your membership portal. </h5><br>
							  <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <a href='dashboard.php'><button  class="btn btn-block btn-lg btn-info">CONTINUE TO MEMBERSHIP PORTAL </button></a>
                                    </div>
                                </div></center> </p>
