...
$sqlinsert = "INSERT INTO loginhistory VALUES ('$id', '$user','$logindate','$logintime')";
if (mysqli_query($conn, $sqlinsert)) {
//get number of logins
$sql8 = "SELECT *FROM loginhistory  WHERE userid='$user'";		   
$result8 = mysqli_query($conn, $sql8);
if (mysqli_num_rows($result8) > 0) {
$activelogins = number_format(mysqli_num_rows($result8));
}
}	
 //
...
$_SESSION['activelogins'] = $activelogins ;
