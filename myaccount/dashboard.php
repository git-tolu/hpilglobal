...
if (empty($compprofile)){
	...
	$compprofile = "<a href ='../adminmanager/$compprofile' target='blank'><img class='responsive' src='assets/images/download.jpg' width='310'></a>";
}
...
if (empty($certincorp)){
	...
	$certincorp = "<a href ='../adminmanager/$certincorp' target='blank'><img class='responsive' src='assets/images/download.jpg' width='310'></a>";
}
...
if (empty($formc07)){
	...
	$formc07 = "<a href ='../adminmanager/$formc07' target='blank'><img class='responsive' src='assets/images/download.jpg' width='310'></a>";
}
$formc02 = $info8['formc02'];
if (empty($formc02)){
	$formc02 = "<img class='responsive' src='assets/images/notuploaded.jpg' width='310'>";
}else{
	$formc02 = "<a href ='../adminmanager/$formc02' target='blank'><img class='responsive' src='assets/images/download.jpg' width='310'></a>";
}
...
if (empty($auditedacct)){
	...
	$auditedacct = "<a href ='../adminmanager/$auditedacct' target='blank'><img class='responsive' src='assets/images/download.jpg' width='310'></a>";
}
}
}
// end
	   ...
	   ?>
        ...
        <h4 class="m-b-0 text-white"><center>CONTACT PERSON INFO.</center></h4></div>
							...
							<div class="col-md-12 col-sm-12 ">
                                        ...
                                        <ul class="list-group">
										<img style="border-style: dotted;" class="p-25 responsive" src="../adminmanager/<?php echo $mpassport; ?>" width="350" /></center>
										<br><img style="border-style: dotted;" class="p-15 responsive" src="../adminmanager/<?php echo $signature; ?>"  width="350" /></center>
