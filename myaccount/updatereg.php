...
$sqlpay = "UPDATE membership set rcno ='$rcno', biznature='$biznature', emailstatus='active', orgfunctions='$joinedString', apconcert='$apconcert', seniorstaff='$seniorstaff', peraddress='$peraddress', percity='$percity', perstate='$perstate', percountry='$percountry', postaladdress='$postaladdress'  WHERE username='$userid'";
...
<div class="card border-info">
    <div class="card-header bg-info">
        <h4 class="m-b-0 text-white"><center>MEMBERSHIP UPDATE FORM</center></h4></div>
    <div class="card-body">
...
echo"<h3><center>Welcome $agencyname!<br>
Please update your membership data to continue</center></h3>";
?>
								...
								<div class="input-group mb-3">
                                  ...
                                  <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button  class="btn btn-block btn-lg btn-info" type="submit" name="submitform">UPDATE & CONTINUE >> </button>
                                    </div>
                                </div>
                            </form>
