...
$totalamountf=number_format($totalamount,2);
 ...
 <br> 
	  <a href='checkowing.php'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-info"> I WILL PAY NOW </button></a>
	  <hr><a href='dashboard.php?firstlogin=yes'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-secondary"> I WILL PAY LATER </button></a>
