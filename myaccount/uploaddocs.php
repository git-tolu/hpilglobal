...
<div class='alert alert-success'><H3><center>Updates Successful!<br>
Now you can upload all required documents here.</center></H3> </div>
                              ...
                              <div class="col-md-12">       
	  <br> 
	  <a href='checkowing.php'><button type="button" class="btn btn-lg waves-effect waves-light btn-block btn-info"> SUBMIT AND CONTINUE>> </button></a>
		</div>
