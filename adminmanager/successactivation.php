    ...
    <div id="main-wrapper">
	  ...
	  ?>
	   ...
	   ?>
        ...
        <h4 class="m-b-0 text-white"><center> ACCOUNT LOGIN CREDENTIALS</center></h4></div>
    
                            <div class="card-body">
                                
							<div class="col-md-12 col-sm-12 ">
                                      
								<p> <center><b>User login credentials successfully sent!</b></p>
                                      <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <a href='fullmembers.php'><button  class="btn btn-block btn-lg btn-info">  RETURN BACK </button></a>
                                    </div>
                                </div>  
                                    </div>
