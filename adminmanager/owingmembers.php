		   ...
		   ?>
            ...
            <div class="container-fluid">
				...
				<div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">MANAGE OWING MEMBERS</h4>
...
$sql8 = "SELECT *FROM membership WHERE status='active' AND approvaladmin='Approved' AND owing='yes' ORDER BY id DESC";		   
...
$sql9 = "SELECT *FROM outstandings WHERE userid='$userid'";		   
$result9 = mysqli_query($conn, $sql9);
if (mysqli_num_rows($result9) > 0) {
	$column_num = 1;
while($info9 = mysqli_fetch_array($result9)) {	
$amountowed = number_format($info9['amountdue'],2);
$remarks = $info9['remarks'];
}
}
